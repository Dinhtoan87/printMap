...
- **Bản đồ nền khi in**: OpenStreetMap, ảnh vệ tinh (Esri), địa hình (Esri), nền sáng (Carto)
  hoặc **không nền (trắng)** — đổi trực tiếp trên thanh công cụ, xem trước ngay.
- **Độ phân giải khi xuất**: 96 / 192 / 288 / 384 DPI (áp cho cả xuất client lẫn server).
...
# DATABASE_URL="postgresql://mapviet:mapviet_dev_password@infra-postgres-1:5432/printdb" \
  DATABASE_URL="postgresql://samcom:Ktcn%402021@192.168.5.36:5432/mo_liet_sy" \
